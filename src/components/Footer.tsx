...
export default function Footer({language}:Props){
    ...
    return (
        <footer>
			<span>© 2026 <a href="https://mrweber.ch" target="_blank">mrweber.ch</a></span>
            <span><a href={`/${language}/${footerPages.dsgvo[language].link}`}>{footerPages.dsgvo[language].name}</a></span>
            <span><a href={`/${language}/${footerPages.imprint[language].link}`}>{footerPages.imprint[language].name}</a></span>
            <div className="socialMedia">
                ...
                <a href="https://x.com/Arsenal_App_CH" target="_blank">
